...
namespace Inventario
{
    public partial class Form1 : Form
    {
        ...
        private void bt_AgregarPrimero_Click(object sender, EventArgs e)
        {
            EntradaInv ent = new EntradaInv()
            {
                Articulo = new Artículo()
        ...
        private void bt_EliminarPrimero_Click(object sender, EventArgs e)
        {
            if (inv.BorrarPrimero())
            {
                MessageBox.Show("El artículo se eliminó correctamente");
                tb_ID.Text = "";
            }
        ...
        private void bt_EliminarUltimo_Click(object sender, EventArgs e)
        {
            if (inv.BorrarUltimo())
            {
                MessageBox.Show("El artículo se eliminó correctamente");
